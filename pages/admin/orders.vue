          ...
          <div class="column is-mobile">
            <div class="breadcrumb-pagination">
              <div
                ...
                @click="changeStatus({ id: o._id, status: 'Pending'})"
              >
                <span>
                  <img class="svgsize" src="/forwardarrow.svg" />
                </span>
                <div>
                  <p class="fntclr" v-bind:class="{Pending:o.status=='Pending'}">Pending</p>
                </div>
              </div>
              <div
                class="circle"
                ...
                type="is-warning"
                @click="changeStatus({ id: o._id,status: 'Shipped'})"
              >
                <span>
                  <img class="svgsize" src="/truckwhite.svg" />
                </span>
                <div>
                  <p class="fntclr" v-bind:class="{Shipped:o.status=='Shipped'}">Shipped</p>
                </div>
              </div>
              <div
                class="circle"
                ...
                type="is-success"
                @click="changeStatus({ id: o._id, status: 'Delivered'})"
              >
                <span>
                  <img class="svgsize" src="/delivered.svg" />
                </span>
                <div>
                  <p class="fntclr2" v-bind:class="{Delivered:o.status=='Delivered'}">Delivered</p>
                </div>
              </div>
              <div
                class="circle"
                ...
                type="is-danger"
                @click="changeStatus({id: o._id, status: 'Cancelled'})"
              >
                <span>
                  <img class="svgsize" src="/backcross.svg" />
                </span>
                <div>
                  <p class="fntclr3" v-bind:class="{Cancelled:o.status=='Cancelled'}">Cancelled</p>
                </div>
              </div>
            </div>
          </div>
