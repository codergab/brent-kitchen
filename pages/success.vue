            ...
            <div class="align">
              <div>
                ...
                <div>
                  ...
                  <p class="font">
                    Transaction ID:
                    <span class="font-weight-bold">{{order.reference}}</span>
                  </p>
                  <h4>You will receive a message or call regarding the confirmation of the product.</h4>
                  <h5>
                    <strong>Note:</strong>Your order will be sent to you, usually within 1hr.
                  </h5>
                </div>
              ...
              <div>
                ...
                <h6>
                  <u>For customer service</u>
                  <br />Please contact:
                  <router-link class="cursor" to>care@brentkitchen.now.sh</router-link>
                </h6>
              </div>
            </div>
          </div>
...
export default {
  ...
  mounted() {
    if (this.$route.query.id) {
      this.fetchOrder(this.$route.query.id);
    } else return { order: {} };
  },
