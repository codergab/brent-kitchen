<template>
  <nav role="navigation" aria-label="main navigation" class="navbar header has-shadow is-primary">
    <div class="headeralign">
      ...
      <div class="header-right navbar-item fx">
        <a role="button" aria-label="menu">
          ...
          <img v-else class="img" src="/person.svg" @click="go('/login')" />
        </a>
        <a role="button" aria-label="menu" @click="go('/cart',false)">
          <img src="/bag.svg" />
        </a>
        <a v-if="user" role="button" aria-label="menu" @click="go('/my/orders',true)">
